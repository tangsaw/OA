...
$typeName=2;//季度总结
if(date('m-d')=='01-10' || date('m-d')=='04-10' ||date('m-d')=='07-10'||date('m-d')=='10-10')
{
	is_insertnotify();
	echo "季度计划执行完毕";
}
...
function is_nodiary(){
    ...
    if(!empty($cursor)){
        ...
        $strTemp.="    <span style=\"font-size: 18px;\"><strong>".$dt." 未提交季度总结人员名单</strong></span><br/>";
        $strTemp.="</p>";
        $strTemp.="<p>";
	...
	{
	    $strTemp.="<p style=\"text-align: center;\">";
        $strTemp.="    <span style=\"font-size: 18px;\"><strong>未提交季度总结人员</strong></span><br/>";
        $strTemp.="</p>";
	}
    return $strTemp;
}
