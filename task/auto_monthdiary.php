...
function is_nodiary(){
    ...
    if(!empty($cursor)){
        ...
        $strTemp.="    <span style=\"font-size: 18px;\"><strong>".$dt." 未提交月度总结人员名单</strong></span><br/>";
        $strTemp.="</p>";
        $strTemp.="<p>";
	...
	{
	    $strTemp.="<p style=\"text-align: center;\">";
        $strTemp.="    <span style=\"font-size: 18px;\"><strong>未提交月度总结人员</strong></span><br/>";
        $strTemp.="</p>";
	}
    return $strTemp;
}
